...
Of course, we are also very focused on the performance of the WebGPU backend. And since seeing is believing, we invite you to run a micro-benchmark yourself below:
